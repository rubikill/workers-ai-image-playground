            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {schema && (
                <div className="space-y-4">
                  ...
                  {Object.entries(schema.input.properties).map(
                    ([key, value]) => (
                      <div key={key} className="space-y-2">
                        ...
                        {key.toLowerCase().includes("prompt") ? (
                          <Textarea
                            ...
                            value={
                              inputValues[key] ||
                              "Urban exploration theme: A young pretty woman with a rugged, road-worn guitar stands in an abandoned warehouse, with shafts of light breaking through grimy windows. The environment is decaying and industrial, creating a stark contrast with the music she might be playing."
                            }
                            onChange={(
